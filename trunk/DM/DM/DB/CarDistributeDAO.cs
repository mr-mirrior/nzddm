...
namespace DM.DB
{
    ...
    public class CarDistributeDAO
    {
         ...
         public int endCars(CarDistribute carDistribute)
        {
            ...
            try
            {
                int updateRowsNumber = DBConnection.executeUpdate(sqlTxt);           
                    ...
                    //更新车辆状态
                    sqlTxt = "update carinfo set blockid=0,maxspeed='0',segmentid=0 where carid in (select carid from cardistribute  where" +
        ...
        //insert cardistribute (blockid,designlayerid,segmentid,carid,DTStart) values(?,?,?,?,getDate());
         public Boolean startCar(CarDistribute carDistribute, Double maxSpeed)
         {
             ...
             try
             {
                 ...
                 sqlTxt = "update carinfo set blockid=" + carDistribute.Blockid + ",maxspeed='" + maxSpeed + "',segmentid=" + carDistribute.Segmentid + " where carid = " + carDistribute.Carid;
        ...
        //启动当前仓面上的车辆
        public Boolean startCars(CarDistribute carDistribute, Double maxspeed)
        {
            //检查是否在使用中            
            SqlConnection conn = null;
            try
            {
                ...
                sqlTxt = "update carinfo set blockid=" + carDistribute.Blockid + ",maxspeed='" + maxspeed + "',segmentid=" + carDistribute.Segmentid + " where carid in (select carid from cardistribute  where  blockid=" + carDistribute.Blockid +
                    " and segmentid=" + carDistribute.Segmentid +
                    " and designz= '" + carDistribute.DesignZ +
