namespace DM.Forms
{
    partial class CoordsInput
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label6.Text = "排除碾压区域边界输入法：形如x11,y11;x12,y12;x13y13|x21,y21;x22,y22;x23,y23;x24,y24 ，即逗号隔离某一点的坝横" +
                "坐标与坝纵坐标，分号隔离两个控制点，竖杠隔离两个排除碾压区域（坐标点请按照顺时针或逆时针依次输入）。排除碾压区域备注输入法：形如 监测仪器埋设|修路 ，竖杠隔离" +
                "两个排除碾压区域备注，顺序应与边界点坐标顺序一致。";
